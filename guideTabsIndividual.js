(function(jQuery) {
    jQuery.fn.guideTabsInd = function(n) {
...
*/
        /*jQuery('a.team_rollover').click(function(event){*/
           ...
           //  jQuery("#gallery").css("display", "block");
            ...
            jQuery("<style type='text/css'> .panel { display:block;width:996px !important;height:426px !important;} </style>").append("div.guidesTheatre");
            ...
            jQuery("#tabs-01 .content").html(guides.guide[number].intro.introTxt);
            
            var introBkg = "url(" + guides.guide[number].intro.bkgImg + ")";
            jQuery("#tabs-01").css({
            	"background-image": introBkg,
            	"width": guides.guide[number].intro.bkgImgWidth + "px",
            	"height": guides.guide[number].intro.bkgImgHeight + "px !important"
            });
            ...
            //var introBkg = "url(" + guides.guide[number].intro.bkgImg + ")";
            //jQuery("#tabs-1").css("background", introBkg);
            ...
            jQuery("#tabs-02").css('background', guides.guide[number].bio.bkgColor);
            jQuery("#tabs-02 p.main").html(guides.guide[number].bio.subTitle);
            jQuery("#tabs-02 div.text").html(guides.guide[number].bio.bioTxt);
            jQuery("#tabs-02 .bio-image").html('<img src="'+ guides.guide[number].bio.bioImg+'" />');
            jQuery("#tabs-02 .content ").css("margin-top", guides.guide[number].intro.introTxtTop + "px");
            

            //build html for achievements
            var division = guides.guide[n].division;
            if (division == "ski" || division == "mountain") {
                jQuery("#tabs-03").css("background", "url("+guides.guide[number].achievements.bkgImg+")");
        ...
        jQuery(v).click(function(e){
            ...
            jQuery("#showVideo").html('<iframe class="youtube-player" type="text/html" width="575" height="380" src="http://www.youtube.com/embed/'+ vidID+'?autohide=1&showinfo=0&autoplay=1" frameborder="0">');
        });
